...
**[samueltechug](https://github.com/katosamuelraymond/samueltechug)** — [live ↗](https://samueltechug.dev)
Personal portfolio, self-hosted on a VPS behind Traefik with GitHub Actions CI/CD.
`Next.js 15` `TypeScript` `Framer Motion` `Docker`

</td>
<td width="50%" valign="top">

**[insightflow_business_ai](https://github.com/katosamuelraymond/insightflow_business_ai)**
Multi-tenant SaaS for AI-powered business intelligence — natural-language queries over APIs, databases, and CSVs.
`Next.js` `TypeScript`
...
**[creative-cube-next](https://github.com/katosamuelraymond/creative-cube-next)**
Full-stack e-commerce platform with an admin dashboard for inventory management.
`Next.js 15` `React 19` `Prisma` `Tailwind`

</td>
<td width="50%" valign="top">

**[savings-sacco](https://github.com/katosamuelraymond/savings-sacco)**
SACCO management system — member accounts, loan processing, multi-branch operations.
`Laravel` `Blade`
...
**[agrolink](https://github.com/katosamuelraymond/agrolink)**
Supply-chain app connecting smallholder farmers, buyers, and transporters in Northern Uganda.
`Flutter` `Dart`

</td>
<td width="50%" valign="top">

**[school-system](https://github.com/katosamuelraymond/school-system)**
School ERP covering academics, finance, and student services.
`Laravel` `Blade`
...
<div align="center">
<sub>Activity and stats above update automatically via GitHub Actions, sourced only from public GitHub data.</sub>
<br/><br/>
